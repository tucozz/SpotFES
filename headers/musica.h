 ...
 * 
 * @warning Conteudo dos ponteiros NAO sao copiados na construcao, mas sao liberados na destruicao
 *
 ...
 * @param artists Lista de tipo @ref Artista
...
Musica *InicializaMusica(char *id, char *name, int popularity, int duration_ms,
                         ...
                         int key, float loudness, enum Mode mode, float speechiness,
